...
class StopCommandTest {
	...
	@Test
	void stop_job_command_should_success()
			throws JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException {
		// Given
		final CommandLine cmd = new CommandLine(stopCommand, factory);
		...
		assertThat(found.getStatus()).isEqualTo(BatchStatus.STOPPING);
	}
