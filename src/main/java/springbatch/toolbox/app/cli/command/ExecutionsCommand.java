...
import springbatch.toolbox.app.cli.command.ExecutionsCommand.ListCommand;
import springbatch.toolbox.app.cli.command.ExecutionsCommand.StatusCommand;
...
public class ExecutionsCommand implements Callable<Integer> {
	...
	static class ListCommand implements Callable<Integer> {
		...
		public Integer call() throws NoSuchJobException {
			...
			jobExecutions.sort((final JobExecution e1, final JobExecution e2) -> e1.getStartTime().compareTo(e2.getStartTime()));
